            ...
            <div class="container-fluid">
                ...
                <div class="lunch item-container">
                    ...
                    <?php
                        ...
                        $sql = "SELECT * FROM `item_info` WHERE item_cat_id='11' OR item_cat_id='12' OR item_cat_id='8' ORDER BY item_id DESC";
                ...
                <!-- see more btn -->
                <div class="see-more">
                    <a href="all_item.php?type=Lunch Item && cat=11 12 8" class="see-more-btn">See More <i class="fa fa-angle-double-right"></i></a>
                </div>
            </div>
        </section>
